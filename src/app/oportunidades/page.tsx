...
// NOTA DO MERGE (main + PR 22): a helper `estaAberta` daqui foi removida, nao
// perdida. Ela existia para a tela decidir "Em aberto" no cliente; a PR 22 levou
// filtro, ordenacao e KPI para o SQL, onde a mesma regra vive em `abertoExpr`
// (NOT EXISTS em `resultados` = sem resultado homologado). Manter a funcao aqui
// deixava-a morta e o lint acusava erro. Se algum dia a tela voltar a decidir isso
// no cliente, o criterio e ausencia de resultado homologado — NAO `situacaoCompraId`,
// que vem desatualizado do PNCP.
